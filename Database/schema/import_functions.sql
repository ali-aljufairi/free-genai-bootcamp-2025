-- Core Data Import Functions for PostgreSQL Migration-- Core Data Import Functions for PostgreSQL Migration-- Core Data Import Functions for PostgreSQL Migration

-- This file has been broken down into smaller, more manageable files

-- for better organization and maintainability.-- This file has been broken down into smaller, more manageable files-- This file has been broken down into smaller, more manageable files



-- The import functions have been split into the following files in the import_functions/ directory:-- for better organization and maintainability.-- for better organization and maintainability.

-- 1. safe_json_extraction_functions.sql - JSON extraction and validation functions

-- 2. text_processing_functions.sql - Japanese text processing functions

-- 3. validation_functions.sql - JLPT level and part of speech validation

-- 4. core_import_functions.sql - Main data import functions (kanji, words, grammar, sentences)-- The import functions have been split into the following files:-- The import functions have been split into the following files:

-- 5. jlpt_questions_import.sql - JLPT questions import system

-- 6. course_import_functions.sql - Course, unit, and relationship imports-- 1. safe_json_extraction_functions.sql - JSON extraction and validation functions-- 1. safe_json_extraction_functions.sql - JSON extraction and validation functions

-- 7. comprehensive_import_functions.sql - Complete import workflows and statistics

-- 8. data_quality_functions.sql - Data quality analysis and group management-- 2. text_processing_functions.sql - Japanese text processing functions-- 2. text_processing_functions.sql - Japanese text processing functions



-- To use these functions, run the individual SQL files in the numbered order above.-- 3. validation_functions.sql - JLPT level and part of speech validation-- 3. validation_functions.sql - JLPT level and part of speech validation

-- The Dockerfile.postgres has been updated to automatically load all these files

-- in the correct order during database initialization.-- 4. core_import_functions.sql - Main data import functions (kanji, words, grammar, sentences)-- 4. core_import_functions.sql - Main data import functions (kanji, words, grammar, sentences)



-- Requirements: 2.1, 2.2, 4.1, 6.1, 7.1-- 5. jlpt_questions_import.sql - JLPT questions import system-- 5. jlpt_questions_import.sql - JLPT questions import system



-- Grant necessary permissions (run this after loading all function files)-- 6. course_import_functions.sql - Course, unit, and relationship imports-- 6. course_import_functions.sql - Course, unit, and relationship imports

GRANT EXECUTE ON ALL FUNCTIONS IN SCHEMA public TO PUBLIC;
-- 7. comprehensive_import_functions.sql - Complete import workflows and statistics-- 7. comprehensive_import_functions.sql - Complete import workflows and statistics

-- 8. data_quality_functions.sql - Data quality analysis and group management-- 8. data_quality_functions.sql - Data quality analysis and group management



-- To use these functions, run the individual SQL files in the following order:-- To use these functions, run the individual SQL files in the following order:

-- 1. safe_json_extraction_functions.sql-- 1. safe_json_extraction_functions.sql

-- 2. text_processing_functions.sql-- 2. text_processing_functions.sql

-- 3. validation_functions.sql-- 3. validation_functions.sql

-- 4. core_import_functions.sql-- 4. core_import_functions.sql

-- 5. jlpt_questions_import.sql-- 5. jlpt_questions_import.sql

-- 6. course_import_functions.sql-- 6. course_import_functions.sql

-- 7. comprehensive_import_functions.sql-- 7. comprehensive_import_functions.sql

-- 8. data_quality_functions.sql-- 8. data_quality_functions.sql



-- Requirements: 2.1, 2.2, 4.1, 6.1, 7.1-- Requirements: 2.1, 2.2, 4.1, 6.1, 7.1



-- Grant necessary permissions (run this after loading all function files)-- Grant necessary permissions (run this after loading all function files)
