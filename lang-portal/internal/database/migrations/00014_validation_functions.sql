...
DROP FUNCTION IF EXISTS validate_part_of_speech(JSONB) CASCADE;
DROP FUNCTION IF EXISTS safe_jsonb_extract_jlpt_level(JSONB, TEXT) CASCADE;
DROP FUNCTION IF EXISTS validate_jlpt_level(TEXT) CASCADE;
