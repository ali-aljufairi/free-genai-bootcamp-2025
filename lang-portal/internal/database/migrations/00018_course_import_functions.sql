...
DROP FUNCTION IF EXISTS import_unit_word_relations(JSONB) CASCADE;
DROP FUNCTION IF EXISTS import_units(JSONB) CASCADE;
DROP FUNCTION IF EXISTS import_book_sets(JSONB) CASCADE;
