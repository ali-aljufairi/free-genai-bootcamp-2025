...
DROP FUNCTION IF EXISTS contains_kanji(TEXT) CASCADE;
DROP FUNCTION IF EXISTS is_hiragana(TEXT) CASCADE;
DROP FUNCTION IF EXISTS is_katakana(TEXT) CASCADE;
DROP FUNCTION IF EXISTS katakana_to_hiragana(TEXT) CASCADE;
