...
import { ReadingQuestionTypeSelector } from "./shared/reading-question-type-selector"
...
interface ReadingQuizConfigProps {
...
export function ReadingQuizConfig({
    preferences,
    onLevelChange,
            ...
            <div className="pb-20">
                ...
                <div className="fixed bottom-0 left-0 right-0 p-4 bg-background/95 backdrop-blur-sm border-t">
                    ...
                    >
                        ...
                        {isLoading ? "Loading..." : "Start Reading Quiz"}
                    </Button>
                </div>
            </div>
        )
