                        ...
                        <div className="flex flex-col items-center justify-center space-y-8">
                            <div className="text-center mb-6">
                                <h2 className={isMobile ? "text-2xl font-bold mb-3" : "text-4xl font-bold mb-4"}>
                                    {score > 0 ? "Words Session Complete!" : "Configure Word Flashcards"}
                                </h2>
                                {score > 0 && (
                                    <div>
                            ...
                            <div className="w-full space-y-6">
                                ...
                                <Button
                                    ...
                                    disabled={isLoading}
                                >
                                    {isLoading ? "Loading..." : score > 0 ? "Study More Words" : "Start Word Study"}
                                </Button>
                            </div>
                        </div>
                    </CardContent>
                    ...
                    <CardContent className="p-4 flex flex-col gap-6">
                        ...
                        >
                            {currentCard.question.kanji && showKanji && (
                                <h2 className="text-4xl font-bold mb-2">{currentCard.question.kanji}</h2>
                            )}
                            {currentCard.question.kana && (
                                <p className="text-3xl text-muted-foreground mb-2">{currentCard.question.kana}</p>
                            )}
            ...
            <Card className="flex-1 glass-card border-0 shadow-lg bg-background/60 backdrop-blur-sm">
                ...
                <CardContent className="p-12">
                    <div className="flex flex-col h-full max-w-6xl mx-auto">
                        ...
                        >
                            {currentCard.question.kanji && showKanji && (
                                <h2 className="text-7xl font-bold mb-4">{currentCard.question.kanji}</h2>
                            )}
                            {currentCard.question.kana && (
                                <p className="text-4xl text-muted-foreground mb-3">{currentCard.question.kana}</p>
                            )}
                            {currentCard.question.romaji && showRomaji && (
