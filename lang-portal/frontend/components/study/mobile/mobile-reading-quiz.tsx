...
import type { ReadingQuestion } from "@/types/api"

interface MobileReadingQuizProps {
    ...
    onExit: () => void
    onShowSettings?: () => void
    renderQuestion: (question: ReadingQuestion) => React.ReactNode
    renderOption: (option: string) => React.ReactNode
}

export function MobileReadingQuiz({
    question,
    currentIndex,
    totalQuestions,
    selectedOption,
