...
export function MobileStudySession({
    ...
    return (
        <div className="fixed inset-0 z-50 bg-background flex flex-col">
            {/* Top Controls - All buttons aligned on same line */}
            ...
            <div className="px-4 py-2 bg-background/50 backdrop-blur-sm">
                <div className="flex items-center justify-between mb-1.5">
                    ...
                    <span className="text-xs font-bold text-primary">{score} / {cards.length}</span>
                </div>
            ...
            {/* Answer Options - Bottom Section with Glass Cards */}
