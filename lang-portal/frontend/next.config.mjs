...
// NOTE: /api/langportal/:path* rewrite is removed to prevent 431 errors
// All /api/langportal/* requests now go through Next.js API routes (app/api/langportal/[...path]/route.ts)
// which properly handle Clerk authentication without forwarding large cookies
if (process.env.NODE_ENV === 'development') {
  nextConfig.rewrites = async () => [
    ...
    // /api/langportal/:path* removed - uses Next.js API routes instead
  ];
}
