                        ...
                        <CardContent>
                            <form onSubmit={handleVerification} className="space-y-6">
                                <div className="space-y-2">
                                    <Label htmlFor="code" className="text-blue-100/90 font-medium">Verification Code</Label>
                                    <Input
                                        id="code"
                                        type="text"
                                        ...
                                        className="h-12 bg-[#0A1120]/40 text-white placeholder:text-blue-200/60 border border-blue-700/40 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/60 rounded-lg backdrop-blur-sm text-center text-lg tracking-widest"
                                        required
                                    />
                                </div>
                ...
                <Card className="glass-card border-0 shadow-2xl bg-background/70 backdrop-blur-lg">
                    ...
                    <CardContent>
                        <div className="flex gap-4 mb-6">
                            ...
                            >
                                <svg className="w-5 h-5" viewBox="0 0 24 24">
                                    <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.085 8.199-11.385 0-6.627-5.373-12-12-12z" fill="currentColor" />
                                </svg>
                                GitHub
                            </Button>
                        </div>
                        ...
                        <div className="relative mb-6">
                            <div className="absolute inset-0 flex items-center">
                                <div className="flex-grow border-t border-blue-700/30"></div>
                            </div>
                            <div className="relative flex justify-center text-sm">
                                <span className="px-2 text-blue-200/80">or sign up with email</span>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <Label htmlFor="email" className="text-blue-100/90 font-medium">Email</Label>
                                    <Input
                                        id="email"
                                        type="email"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        required
                                    />
                                    <p className="text-xs text-blue-200/60">Must be at least 8 characters</p>
                                </div>
                            </div>
                        ...
                        <div className="mt-8 text-center">
                            <div className="flex items-center justify-center text-sm text-blue-200/70">
                                <span>Already have an account?</span>
                                <Button
                                    variant="link"
                                    className="text-blue-400 hover:text-blue-300 font-medium transition-colors text-sm p-0 ml-2"
                    ...
                    <CardFooter className="flex flex-col items-center justify-center pb-6">
                        <div className="flex items-center justify-center text-sm text-muted-foreground">
                            ...
                            <span>Begin your learning adventure</span>
                        </div>
                    </CardFooter>
                </Card>
            </div>
